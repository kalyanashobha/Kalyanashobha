...
import { 
  ...
  ChevronDown,
  Info,
  Sliders // <-- Added Sliders icon for Preferences
} from 'lucide-react';
import './Navbar.css';
        ...
        <nav className="main-nav">
          <ul className="main-nav-list">
            ...
            <li className="main-nav-item ks-dropdown-container">
              {/* Added /preference to the active check */}
              <button className={`main-nav-link ks-dropdown-trigger ${['/terms', '/refund', '/faq', '/help', '/preference'].includes(location.pathname) ? 'active' : ''}`}>
          ...
          <ul className="mobile-menu-list">
            ...
            {isLoggedIn && (
              <>
                ...
                {/* NEW: Partner Preferences Mobile Link */}
                <li style={{ '--i': 4 }}>
