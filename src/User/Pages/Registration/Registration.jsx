    ...
    return (
        <div key={step} className={`reg-form-body ${animDirection}`}>
            ...
            {step === 2 && (
                ...
                <div className={`reg-input-block reg-stagger ${errors.dobYear ? 'reg-error-state' : ''}`}>
                   ...
                   {errors.dobYear && <span className="reg-error-text">{errors.dobYear}</span>}
                </div>
                </>
            )}
