      ...
      <div className="profile-card fade-in">
        <div className="profile-card__header">
          ...
          <div className="profile-card__user-info">
            ...
            {isConnected && (
              <span className="managed-by-admin-text">
                MANAGED BY ADMIN
              </span>
            )}
          </div>
        ...
        <div className="profile-card__details">
          ...
          <div className="detail-item">
            ...
            <span className="detail-item__value">{profile?.city ? `${profile.city}, ${profile.state}` : "--"}</span>
          </div>
          <div className="detail-item">
            <span className="detail-item__label">Community</span>
            <span className="detail-item__value">{profile?.community || profile?.caste || "--"}</span>
          </div>
          <div className="detail-item">
            <span className="detail-item__label">Sub-Community</span>
            <span className="detail-item__value">{profile?.subCommunity || "--"}</span>
          </div>
          <div className="detail-item">
