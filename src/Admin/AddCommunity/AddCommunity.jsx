...
const CATEGORIES = [
  { id: 'Country', label: 'Country' }, // Moved to the top
                           ...
                           <Draggable key={item._id} draggableId={item._id} index={index}>
                             {(provided, snapshot) => (
                               <div 
                                 ...
                                 {...provided.dragHandleProps} // Moved here to make the whole card draggable
                               ...
                               >
                                 <div className="sys-cfg-card-header">
                                     <div className="sys-cfg-data-content">
                                         {/* Kept icon for UI, but it's no longer the sole drag handle */}
                                                ...
                                                <Draggable key={`${item._id}-${sub}`} draggableId={`${item._id}-${sub}`} index={subIdx}>
                                                  {(providedDragSub, snapshotDragSub) => (
                                                     <div 
                                                        ...
                                                        {...providedDragSub.dragHandleProps} // Moved here to make the whole sub-card draggable
                    ...
                    {(provided, snapshot) => (
                      <div ref={provided.innerRef} {...provided.droppableProps} className="sys-cfg-page-drop-wrapper">
                        <button 
                          ...
                          onMouseEnter={() => setCurrentPage(prev => Math.max(prev - 1, 1))}
                    ...
                    {(provided, snapshot) => (
                      <div ref={provided.innerRef} {...provided.droppableProps} className="sys-cfg-page-drop-wrapper">
                        <button 
                          ...
                          onMouseEnter={() => setCurrentPage(prev => Math.min(prev + 1, totalPages))}
