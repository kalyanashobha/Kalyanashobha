...
const AgentDashboard = () => {
  ...
  const [dynamicOptions, setDynamicOptions] = useState({
      Education: [], Designation: [], Income: [], Country: [], State: [], City: [], Height: [], Diet: [], Sector: [], MaritalStatus: []
  });
  ...
  const [regData, setRegData] = useState({
    ...
    jobRole: '', companyName: '', annualIncome: '', nri: 'No', // <-- ADDED NRI HERE
  ...
  const fetchDynamicMasterData = async () => {
      // Added Sector and MaritalStatus
      const categories = ['Education', 'Designation', 'Income', 'Country', 'State', 'City', 'Height', 'Diet', 'Sector', 'MaritalStatus'];
  ...
  const validateStep = (step) => {
    switch(step) {
      ...
      case 3:
        ...
        return true;
      case 4:
        // Check Gothra as mandatory here
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    // Extract exactly the numeric CM value out of the formatted string
    ...
    const payload = {
      ...
      age: calculatedAge, // Sending calculated age to backend
    ...
    try {
      ...
      if (data.success) {
        ...
        setRegData({ 
          ...
          country: '', state: '', city: '', residentsIn: 'Own',
          highestQualification: '', collegeName: '', workType: '', 
          jobRole: '', companyName: '', annualIncome: '', nri: 'No', // Reset NRI
          mobileNumber: '', email: '', password: ''
        });
                ...
                <form id="app-agent-reg-form" onSubmit={handleRegisterSubmit}>
                  ...
                  {regStep === 5 && (
                    <div className="app-step-content app-slide-fwd">
                      ...
                      {/* Added NRI Status Dropdown Here */}
                      <div className="app-form-grid mt-4">
                        <AgentSelect 
